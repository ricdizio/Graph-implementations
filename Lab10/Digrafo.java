...
public class Digrafo implements Grafo
{
    ...
    public boolean cargarGrafo(String dirArchivo){
        ...
        /*try{
            ...
            //System.out.println(dependenciasL);
            //System.out.println(arregloDependencias.length);
            agregarVertice(verticeVerDependencias,0.0);
            for (int i = 0; i < arregloDependencias.length; i++) {
                agregarVertice(arregloDependencias[i],0.0);
                agregarArco(String.valueOf(contadorArcos),0.0,verticeVerDependencias,arregloDependencias[i]);
   ...
   /**
    ...
    public boolean agregarVertice(Vertice v) { 
        ...
        {
            //System.out.println("El vertice con identificador "+v.getId()+" ya se encuentra en el grafo.");
            return false;
        }
